...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000078d46d3400007f6cedb6ab95(
...
class phpbbtemplatetwiglexer_0000000078d46d3400007f6cedb6ab95 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5b7ad3052e410955329830 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5b7ad3052e420961891236 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5b7ad3052e3e0346635498 = array(
    ...
    {
        $this->initializer5b7ad3052e420961891236 && ($this->initializer5b7ad3052e420961891236->__invoke($valueHolder5b7ad3052e410955329830, $this, 'set_environment', array('env' => $env), $this->initializer5b7ad3052e420961891236) || 1) && $this->valueHolder5b7ad3052e410955329830 = $valueHolder5b7ad3052e410955329830;

        return $this->valueHolder5b7ad3052e410955329830->set_environment($env);
    }
    ...
    {
        $this->initializer5b7ad3052e420961891236 && ($this->initializer5b7ad3052e420961891236->__invoke($valueHolder5b7ad3052e410955329830, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5b7ad3052e420961891236) || 1) && $this->valueHolder5b7ad3052e410955329830 = $valueHolder5b7ad3052e410955329830;

        return $this->valueHolder5b7ad3052e410955329830->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5b7ad3052e420961891236 && ($this->initializer5b7ad3052e420961891236->__invoke($valueHolder5b7ad3052e410955329830, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5b7ad3052e420961891236) || 1) && $this->valueHolder5b7ad3052e410955329830 = $valueHolder5b7ad3052e410955329830;

        return $this->valueHolder5b7ad3052e410955329830->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5b7ad3052e420961891236 = $initializer;
    }
    ...
    {
        $this->initializer5b7ad3052e420961891236 && ($this->initializer5b7ad3052e420961891236->__invoke($valueHolder5b7ad3052e410955329830, $this, '__get', array('name' => $name), $this->initializer5b7ad3052e420961891236) || 1) && $this->valueHolder5b7ad3052e410955329830 = $valueHolder5b7ad3052e410955329830;

        if (isset(self::$publicProperties5b7ad3052e3e0346635498[$name])) {
            return $this->valueHolder5b7ad3052e410955329830->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5b7ad3052e410955329830;
    ...
    {
        $this->initializer5b7ad3052e420961891236 && ($this->initializer5b7ad3052e420961891236->__invoke($valueHolder5b7ad3052e410955329830, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5b7ad3052e420961891236) || 1) && $this->valueHolder5b7ad3052e410955329830 = $valueHolder5b7ad3052e410955329830;
    ...
    {
        $this->initializer5b7ad3052e420961891236 && ($this->initializer5b7ad3052e420961891236->__invoke($valueHolder5b7ad3052e410955329830, $this, '__isset', array('name' => $name), $this->initializer5b7ad3052e420961891236) || 1) && $this->valueHolder5b7ad3052e410955329830 = $valueHolder5b7ad3052e410955329830;
    ...
    {
        $this->initializer5b7ad3052e420961891236 && ($this->initializer5b7ad3052e420961891236->__invoke($valueHolder5b7ad3052e410955329830, $this, '__unset', array('name' => $name), $this->initializer5b7ad3052e420961891236) || 1) && $this->valueHolder5b7ad3052e410955329830 = $valueHolder5b7ad3052e410955329830;
    ...
    {
        $this->initializer5b7ad3052e420961891236 && ($this->initializer5b7ad3052e420961891236->__invoke($valueHolder5b7ad3052e410955329830, $this, '__clone', array(), $this->initializer5b7ad3052e420961891236) || 1) && $this->valueHolder5b7ad3052e410955329830 = $valueHolder5b7ad3052e410955329830;

        $this->valueHolder5b7ad3052e410955329830 = clone $this->valueHolder5b7ad3052e410955329830;
    }

    public function __sleep()
    {
        $this->initializer5b7ad3052e420961891236 && ($this->initializer5b7ad3052e420961891236->__invoke($valueHolder5b7ad3052e410955329830, $this, '__sleep', array(), $this->initializer5b7ad3052e420961891236) || 1) && $this->valueHolder5b7ad3052e410955329830 = $valueHolder5b7ad3052e410955329830;

        return array('valueHolder5b7ad3052e410955329830');
    }
    ...
    {
        return $this->initializer5b7ad3052e420961891236;
    }
    ...
    {
        return $this->initializer5b7ad3052e420961891236 && ($this->initializer5b7ad3052e420961891236->__invoke($valueHolder5b7ad3052e410955329830, $this, 'initializeProxy', array(), $this->initializer5b7ad3052e420961891236) || 1) && $this->valueHolder5b7ad3052e410955329830 = $valueHolder5b7ad3052e410955329830;
    }
    ...
    {
        return null !== $this->valueHolder5b7ad3052e410955329830;
    }
    ...
    {
        return $this->valueHolder5b7ad3052e410955329830;
    }
