...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000001dfdc73000007fbc0005ac87(
...
class phpbbtemplatetwiglexer_000000001dfdc73000007fbc0005ac87 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5b7ade320dbf9566896781 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5b7ade320dc0b953268289 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5b7ade320dbb9546914402 = array(
    ...
    {
        $this->initializer5b7ade320dc0b953268289 && ($this->initializer5b7ade320dc0b953268289->__invoke($valueHolder5b7ade320dbf9566896781, $this, 'set_environment', array('env' => $env), $this->initializer5b7ade320dc0b953268289) || 1) && $this->valueHolder5b7ade320dbf9566896781 = $valueHolder5b7ade320dbf9566896781;

        return $this->valueHolder5b7ade320dbf9566896781->set_environment($env);
    }
    ...
    {
        $this->initializer5b7ade320dc0b953268289 && ($this->initializer5b7ade320dc0b953268289->__invoke($valueHolder5b7ade320dbf9566896781, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5b7ade320dc0b953268289) || 1) && $this->valueHolder5b7ade320dbf9566896781 = $valueHolder5b7ade320dbf9566896781;

        return $this->valueHolder5b7ade320dbf9566896781->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5b7ade320dc0b953268289 && ($this->initializer5b7ade320dc0b953268289->__invoke($valueHolder5b7ade320dbf9566896781, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5b7ade320dc0b953268289) || 1) && $this->valueHolder5b7ade320dbf9566896781 = $valueHolder5b7ade320dbf9566896781;

        return $this->valueHolder5b7ade320dbf9566896781->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5b7ade320dc0b953268289 = $initializer;
    }
    ...
    {
        $this->initializer5b7ade320dc0b953268289 && ($this->initializer5b7ade320dc0b953268289->__invoke($valueHolder5b7ade320dbf9566896781, $this, '__get', array('name' => $name), $this->initializer5b7ade320dc0b953268289) || 1) && $this->valueHolder5b7ade320dbf9566896781 = $valueHolder5b7ade320dbf9566896781;

        if (isset(self::$publicProperties5b7ade320dbb9546914402[$name])) {
            return $this->valueHolder5b7ade320dbf9566896781->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5b7ade320dbf9566896781;
    ...
    {
        $this->initializer5b7ade320dc0b953268289 && ($this->initializer5b7ade320dc0b953268289->__invoke($valueHolder5b7ade320dbf9566896781, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5b7ade320dc0b953268289) || 1) && $this->valueHolder5b7ade320dbf9566896781 = $valueHolder5b7ade320dbf9566896781;
    ...
    {
        $this->initializer5b7ade320dc0b953268289 && ($this->initializer5b7ade320dc0b953268289->__invoke($valueHolder5b7ade320dbf9566896781, $this, '__isset', array('name' => $name), $this->initializer5b7ade320dc0b953268289) || 1) && $this->valueHolder5b7ade320dbf9566896781 = $valueHolder5b7ade320dbf9566896781;
    ...
    {
        $this->initializer5b7ade320dc0b953268289 && ($this->initializer5b7ade320dc0b953268289->__invoke($valueHolder5b7ade320dbf9566896781, $this, '__unset', array('name' => $name), $this->initializer5b7ade320dc0b953268289) || 1) && $this->valueHolder5b7ade320dbf9566896781 = $valueHolder5b7ade320dbf9566896781;
    ...
    {
        $this->initializer5b7ade320dc0b953268289 && ($this->initializer5b7ade320dc0b953268289->__invoke($valueHolder5b7ade320dbf9566896781, $this, '__clone', array(), $this->initializer5b7ade320dc0b953268289) || 1) && $this->valueHolder5b7ade320dbf9566896781 = $valueHolder5b7ade320dbf9566896781;

        $this->valueHolder5b7ade320dbf9566896781 = clone $this->valueHolder5b7ade320dbf9566896781;
    }

    public function __sleep()
    {
        $this->initializer5b7ade320dc0b953268289 && ($this->initializer5b7ade320dc0b953268289->__invoke($valueHolder5b7ade320dbf9566896781, $this, '__sleep', array(), $this->initializer5b7ade320dc0b953268289) || 1) && $this->valueHolder5b7ade320dbf9566896781 = $valueHolder5b7ade320dbf9566896781;

        return array('valueHolder5b7ade320dbf9566896781');
    }
    ...
    {
        return $this->initializer5b7ade320dc0b953268289;
    }
    ...
    {
        return $this->initializer5b7ade320dc0b953268289 && ($this->initializer5b7ade320dc0b953268289->__invoke($valueHolder5b7ade320dbf9566896781, $this, 'initializeProxy', array(), $this->initializer5b7ade320dc0b953268289) || 1) && $this->valueHolder5b7ade320dbf9566896781 = $valueHolder5b7ade320dbf9566896781;
    }
    ...
    {
        return null !== $this->valueHolder5b7ade320dbf9566896781;
    }
    ...
    {
        return $this->valueHolder5b7ade320dbf9566896781;
    }
