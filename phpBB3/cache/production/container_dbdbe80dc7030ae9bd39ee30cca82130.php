...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'phpbb4_oauth_tokens', 'phpbb4_oauth_states', 'phpbb4_oauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'phpbb4_users', $this, $this->get('dispatcher'), './../', 'php');
    }
    ...
    {
        return $this->services['config'] = new \phpbb\config\db($this->get('dbal.conn'), $this->get('cache.driver'), 'phpbb4_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text($this->get('dbal.conn'), 'phpbb4_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), './../', 'php', 'phpbb4_forums', 'phpbb4_posts', 'phpbb4_topics', 'phpbb4_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('phpbb4_captcha_questions', 'phpbb4_captcha_answers', 'phpbb4_qa_confirm');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), 'phpbb4_ext', './../', 'php', $this->get('cache'));
    }
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), './../', 'adm/', 'php', 'phpbb4_log');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'phpbb4_migrations', './../', 'php', 'phpbb4_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), $this->get('module.manager'), './../', 'php', 'phpbb4_modules');
    }
    ...
    {
        return $this->services['module.manager'] = new \phpbb\module\module_manager($this->get('cache.driver'), $this->get('dbal.conn'), $this->get('ext.manager'), 'phpbb4_modules', './../', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\board($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('config'), 'phpbb4_notification_types', 'phpbb4_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb4_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb4_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb4_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\bookmark($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb4_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb4_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb4_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\group_request($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb4_user_notifications');
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb4_user_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb4_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb4_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb4_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\quote($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb4_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb4_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb4_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb4_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb4_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb4_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'phpbb4_user_notifications');
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('language'), $this->get('user'), 'phpbb4_notification_types', 'phpbb4_user_notifications');
    }
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper($this->get('dbal.conn'), 'phpbb4_profile_fields_lang');
    }
    ...
    {
        return $this->services['profilefields.manager'] = new \phpbb\profilefields\manager($this->get('auth'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('request'), $this->get('template'), $this->get('profilefields.type_collection'), $this->get('user'), 'phpbb4_profile_fields', 'phpbb4_profile_lang', 'phpbb4_profile_fields_data');
    }
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000006569f83200007f760313bdaf(
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access($this->get('dbal.conn'), 'phpbb4_bbcodes', 'phpbb4_smilies', 'phpbb4_styles', 'phpbb4_words', './../styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description($this->get('dbal.conn'), 'phpbb4_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules($this->get('dbal.conn'), 'phpbb4_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description($this->get('dbal.conn'), 'phpbb4_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text($this->get('dbal.conn'), 'phpbb4_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title($this->get('dbal.conn'), 'phpbb4_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text($this->get('dbal.conn'), 'phpbb4_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature($this->get('dbal.conn'), 'phpbb4_users');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), './../', 'php', 'phpbb4_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'tables.acl_groups' => 'phpbb4_acl_groups',
            'tables.acl_options' => 'phpbb4_acl_options',
            'tables.acl_roles' => 'phpbb4_acl_roles',
            'tables.acl_roles_data' => 'phpbb4_acl_roles_data',
            'tables.acl_users' => 'phpbb4_acl_users',
            'tables.attachments' => 'phpbb4_attachments',
            'tables.auth_provider_oauth_token_storage' => 'phpbb4_oauth_tokens',
            'tables.auth_provider_oauth_states' => 'phpbb4_oauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'phpbb4_oauth_accounts',
            'tables.banlist' => 'phpbb4_banlist',
            'tables.bbcodes' => 'phpbb4_bbcodes',
            'tables.bookmarks' => 'phpbb4_bookmarks',
            'tables.bots' => 'phpbb4_bots',
            'tables.captcha_qa_questions' => 'phpbb4_captcha_questions',
            'tables.captcha_qa_answers' => 'phpbb4_captcha_answers',
            'tables.captcha_qa_confirm' => 'phpbb4_qa_confirm',
            'tables.config' => 'phpbb4_config',
            'tables.config_text' => 'phpbb4_config_text',
            'tables.confirm' => 'phpbb4_confirm',
            'tables.disallow' => 'phpbb4_disallow',
            'tables.drafts' => 'phpbb4_drafts',
            'tables.ext' => 'phpbb4_ext',
            'tables.extensions' => 'phpbb4_extensions',
            'tables.extension_groups' => 'phpbb4_extension_groups',
            'tables.forums' => 'phpbb4_forums',
            'tables.forums_access' => 'phpbb4_forums_access',
            'tables.forums_track' => 'phpbb4_forums_track',
            'tables.forums_watch' => 'phpbb4_forums_watch',
            'tables.groups' => 'phpbb4_groups',
            'tables.icons' => 'phpbb4_icons',
            'tables.lang' => 'phpbb4_lang',
            'tables.log' => 'phpbb4_log',
            'tables.login_attempts' => 'phpbb4_login_attempts',
            'tables.migrations' => 'phpbb4_migrations',
            'tables.moderator_cache' => 'phpbb4_moderator_cache',
            'tables.modules' => 'phpbb4_modules',
            'tables.notification_types' => 'phpbb4_notification_types',
            'tables.notifications' => 'phpbb4_notifications',
            'tables.poll_options' => 'phpbb4_poll_options',
            'tables.poll_votes' => 'phpbb4_poll_votes',
            'tables.posts' => 'phpbb4_posts',
            'tables.privmsgs' => 'phpbb4_privmsgs',
            'tables.privmsgs_folder' => 'phpbb4_privmsgs_folder',
            'tables.privmsgs_rules' => 'phpbb4_privmsgs_rules',
            'tables.privmsgs_to' => 'phpbb4_privmsgs_to',
            'tables.profile_fields' => 'phpbb4_profile_fields',
            'tables.profile_fields_data' => 'phpbb4_profile_fields_data',
            'tables.profile_fields_options_language' => 'phpbb4_profile_fields_lang',
            'tables.profile_fields_language' => 'phpbb4_profile_lang',
            'tables.ranks' => 'phpbb4_ranks',
            'tables.reports' => 'phpbb4_reports',
            'tables.reports_reasons' => 'phpbb4_reports_reasons',
            'tables.search_results' => 'phpbb4_search_results',
            'tables.search_wordlist' => 'phpbb4_search_wordlist',
            'tables.search_wordmatch' => 'phpbb4_search_wordmatch',
            'tables.sessions' => 'phpbb4_sessions',
            'tables.sessions_keys' => 'phpbb4_sessions_keys',
            'tables.sitelist' => 'phpbb4_sitelist',
            'tables.smilies' => 'phpbb4_smilies',
            'tables.sphinx' => 'phpbb4_sphinx',
            'tables.styles' => 'phpbb4_styles',
            'tables.styles_template' => 'phpbb4_styles_template',
            'tables.styles_template_data' => 'phpbb4_styles_template_data',
            'tables.styles_theme' => 'phpbb4_styles_theme',
            'tables.styles_imageset' => 'phpbb4_styles_imageset',
            'tables.styles_imageset_data' => 'phpbb4_styles_imageset_data',
            'tables.teampage' => 'phpbb4_teampage',
            'tables.topics' => 'phpbb4_topics',
            'tables.topics_posted' => 'phpbb4_topics_posted',
            'tables.topics_track' => 'phpbb4_topics_track',
            'tables.topics_watch' => 'phpbb4_topics_watch',
            'tables.user_group' => 'phpbb4_user_group',
            'tables.user_notifications' => 'phpbb4_user_notifications',
            'tables.users' => 'phpbb4_users',
            'tables.warnings' => 'phpbb4_warnings',
            'tables.words' => 'phpbb4_words',
            'tables.zebra' => 'phpbb4_zebra',
...
class phpbbtemplatetwiglexer_000000006569f83200007f760313bdaf extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5b7addae106b7536881760 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5b7addae106cb925986881 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5b7addae10667099537563 = array(
    ...
    {
        $this->initializer5b7addae106cb925986881 && ($this->initializer5b7addae106cb925986881->__invoke($valueHolder5b7addae106b7536881760, $this, 'set_environment', array('env' => $env), $this->initializer5b7addae106cb925986881) || 1) && $this->valueHolder5b7addae106b7536881760 = $valueHolder5b7addae106b7536881760;

        return $this->valueHolder5b7addae106b7536881760->set_environment($env);
    }
    ...
    {
        $this->initializer5b7addae106cb925986881 && ($this->initializer5b7addae106cb925986881->__invoke($valueHolder5b7addae106b7536881760, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5b7addae106cb925986881) || 1) && $this->valueHolder5b7addae106b7536881760 = $valueHolder5b7addae106b7536881760;

        return $this->valueHolder5b7addae106b7536881760->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5b7addae106cb925986881 && ($this->initializer5b7addae106cb925986881->__invoke($valueHolder5b7addae106b7536881760, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5b7addae106cb925986881) || 1) && $this->valueHolder5b7addae106b7536881760 = $valueHolder5b7addae106b7536881760;

        return $this->valueHolder5b7addae106b7536881760->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5b7addae106cb925986881 = $initializer;
    }
    ...
    {
        $this->initializer5b7addae106cb925986881 && ($this->initializer5b7addae106cb925986881->__invoke($valueHolder5b7addae106b7536881760, $this, '__get', array('name' => $name), $this->initializer5b7addae106cb925986881) || 1) && $this->valueHolder5b7addae106b7536881760 = $valueHolder5b7addae106b7536881760;

        if (isset(self::$publicProperties5b7addae10667099537563[$name])) {
            return $this->valueHolder5b7addae106b7536881760->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5b7addae106b7536881760;
    ...
    {
        $this->initializer5b7addae106cb925986881 && ($this->initializer5b7addae106cb925986881->__invoke($valueHolder5b7addae106b7536881760, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5b7addae106cb925986881) || 1) && $this->valueHolder5b7addae106b7536881760 = $valueHolder5b7addae106b7536881760;
    ...
    {
        $this->initializer5b7addae106cb925986881 && ($this->initializer5b7addae106cb925986881->__invoke($valueHolder5b7addae106b7536881760, $this, '__isset', array('name' => $name), $this->initializer5b7addae106cb925986881) || 1) && $this->valueHolder5b7addae106b7536881760 = $valueHolder5b7addae106b7536881760;
    ...
    {
        $this->initializer5b7addae106cb925986881 && ($this->initializer5b7addae106cb925986881->__invoke($valueHolder5b7addae106b7536881760, $this, '__unset', array('name' => $name), $this->initializer5b7addae106cb925986881) || 1) && $this->valueHolder5b7addae106b7536881760 = $valueHolder5b7addae106b7536881760;
    ...
    {
        $this->initializer5b7addae106cb925986881 && ($this->initializer5b7addae106cb925986881->__invoke($valueHolder5b7addae106b7536881760, $this, '__clone', array(), $this->initializer5b7addae106cb925986881) || 1) && $this->valueHolder5b7addae106b7536881760 = $valueHolder5b7addae106b7536881760;

        $this->valueHolder5b7addae106b7536881760 = clone $this->valueHolder5b7addae106b7536881760;
    }

    public function __sleep()
    {
        $this->initializer5b7addae106cb925986881 && ($this->initializer5b7addae106cb925986881->__invoke($valueHolder5b7addae106b7536881760, $this, '__sleep', array(), $this->initializer5b7addae106cb925986881) || 1) && $this->valueHolder5b7addae106b7536881760 = $valueHolder5b7addae106b7536881760;

        return array('valueHolder5b7addae106b7536881760');
    }
    ...
    {
        return $this->initializer5b7addae106cb925986881;
    }
    ...
    {
        return $this->initializer5b7addae106cb925986881 && ($this->initializer5b7addae106cb925986881->__invoke($valueHolder5b7addae106b7536881760, $this, 'initializeProxy', array(), $this->initializer5b7addae106cb925986881) || 1) && $this->valueHolder5b7addae106b7536881760 = $valueHolder5b7addae106b7536881760;
    }
    ...
    {
        return null !== $this->valueHolder5b7addae106b7536881760;
    }
    ...
    {
        return $this->valueHolder5b7addae106b7536881760;
    }
